...
cp "$root/scripts/release-package.sh" "$fixture/repo/scripts/"
...
expect_failure ./scripts/release-package.sh not-a-version
expect_failure ./scripts/release-package.sh v0.4.0-rc.01
expect_failure ./scripts/release-package.sh v0.4.0-rc.
expect_failure ./scripts/release-package.sh v0.5.0
expect_failure env PACKAGE_VERSION=0.3.0 ./scripts/release-package.sh v0.4.0
printf 'dirty\n' >> LICENSE
