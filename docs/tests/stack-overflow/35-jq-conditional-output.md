...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| jq | JSON | timed | 2.962 | +0.0% | 2.69 (darwin-wait4) | +0.0% | 30 (+1 warmup) |
| yq | JSON | timed | 5.006 | +69.1% | 15.16 (darwin-wait4) | +464.0% | 30 (+1 warmup) |
| tq | TOON | timed | 2.568 | -13.3% | 4.11 (darwin-wait4) | +52.9% | 30 (+1 warmup) |
...
Status: `exited-0`.
Command: `tq --input-format json '.geo != null'`
