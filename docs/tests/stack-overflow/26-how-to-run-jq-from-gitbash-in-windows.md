...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| jq | JSON | timed | 120.962 | +0.0% | 2.59 (bsd-time-l) | +0.0% | 30 (+1 warmup) |
| yq | JSON | timed | 127.933 | +5.8% | 15.94 (bsd-time-l) | +514.5% | 30 (+1 warmup) |
| tq | TOON | timed | 120.354 | -0.5% | 3.62 (bsd-time-l) | +39.8% | 30 (+1 warmup) |
