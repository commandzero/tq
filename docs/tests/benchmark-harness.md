...
The recorded historical campaign ran the full 39-workload catalog on Linux using only
...
These measurements do not validate the current PR head. Current-head test
results and any new performance campaign must be recorded separately.
