...
The inventory above records source-to-case coverage. The generated Results below record the subsequent compatibility execution; inventory coverage alone does not establish parity.
