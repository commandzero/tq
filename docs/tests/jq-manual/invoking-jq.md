...
The generated Results block below also preserves the help text captured during
that historical run. Its option listing is not a current tq CLI contract and
may omit options added later. See the [current jq/tq option inventory](../../jq-1.8-cli-options.md)
