---
type: Report
title: "Math audit model and TOON savings"
description: "Recorded review of Math audit model and TOON savings."
generated: { by: codex/gpt-6, at: 2026-09-10T02:12:04Z }
---

# Math audit model and TOON savings

The corrected math ledger is stored as [canonical TOON](../../../tests/compatibility/reviews/jq-manual/math.toon).
...
tq --input-format toon -o json . tests/compatibility/reviews/jq-manual/math.toon | tq -x
```
