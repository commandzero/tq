...
Define strict, ordered JSON Lines input and output so each physical record has an unambiguous parse boundary and each emitted result remains independently consumable.
